...
public class TicketsAdapter extends RecyclerView.Adapter<TicketsAdapter.ViewHolder> {
    ...
    public TicketsAdapter(List<TicketsDetails> ticketsDetails,Context context){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_tickets_details,viewGroup,false);
        return  new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        TicketsDetails ticketDetail = ticketsDetails.get(i);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            textViewname=(TextView) itemView.findViewById(R.id.nameofuser);
